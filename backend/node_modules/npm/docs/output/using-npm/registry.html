...
<a href="scope.html"><code>scope</code></a>. If no scope is specified, the default registry is
...
<a href="../configuring-npm/npmrc.html"><code>npmrc</code></a>, and <a href="config.html"><code>config</code></a> for more on
