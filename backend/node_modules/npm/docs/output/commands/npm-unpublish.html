...
<p>Consider using the <a href="npm-deprecate.html"><code>deprecate</code></a> command instead,
...
<p>The npm registry will return an error if you are not <a href="npm-adduser.html">logged
in</a>.</p>
