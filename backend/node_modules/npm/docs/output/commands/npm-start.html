...
use custom arguments when executing scripts. Refer to <a href="npm-run-script.html"><code>npm run-script</code></a> for more details.</p>
...
<ul>
<li><a href="npm-run-script.html">npm run-script</a></li>
