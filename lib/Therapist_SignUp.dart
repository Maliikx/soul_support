...
import 'package:flutter_application_1/Therapist_WelcomeAddPhoto.dart';
import 'package:flutter_application_1/verification_choice.dart';
...
class TherapistSignUp extends StatefulWidget {
  ...
  @override
  _TherapistSignUp createState() => _TherapistSignUp();
}

class _TherapistSignUp extends State<TherapistSignUp> {
          ...
          Stack(
            children: [
              ...
              Positioned(
                ...
                child: Container(
                    height: 110,
                    child: Image.asset("Assets/Group 36731.png")
                ),
              ),
              Padding(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsets.only(left: horizontalPadding),
                                child: Text("doctor's card", style: labelStyle),
                              ),
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: horizontalPadding),
                                child: TextFormField(
                                  controller: _numberController,
                                  keyboardType: TextInputType.number, // numeric keyboard for IDs
                                  decoration: InputDecoration(
                                    filled: true,
                                    fillColor: _textColor,
                                    contentPadding: const EdgeInsets.symmetric(vertical: 12, horizontal: 15),
                                  ...
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                                      return 'Please enter your doctor card';
                                    }
                                    // Example: national ID must be exactly 10 digits (adjust to your format)
                                    if (!RegExp(r'^\d{10}$').hasMatch(value)) {
                                      return 'Please enter a valid doctor card';
                                    }
                                    return null;
                                  },
                                ),
