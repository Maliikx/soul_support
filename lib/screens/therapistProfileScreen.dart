    ...
    return Scaffold(
        body: Stack(
          ...
          children: [
                                    ...
                                    if (_border0 != BoxDecoration() &&
                                      ...
                                      _border0 = BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(
                                            32), // Rounded corners
                                        border: Border.all(
                                            color: Color(0xFF97CADB), width: 6),
                                      );
            ...
            Positioned(bottom: 30, child: Dock(currentIndex: 2)),
            Exitbtn()
          ],
        ));
  }
