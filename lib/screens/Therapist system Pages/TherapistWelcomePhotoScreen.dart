...
class TherapistWelcomePhotoScreen extends StatefulWidget {
  const TherapistWelcomePhotoScreen({super.key});

  @override
  _TherapistWelcomeScreenState createState() => _TherapistWelcomeScreenState();
}

class _TherapistWelcomeScreenState extends State<TherapistWelcomePhotoScreen> {
  @override
